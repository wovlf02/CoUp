-- CreateEnum
CREATE TYPE "StudyRole" AS ENUM ('ADMIN', 'MEMBER');
...
CREATE TABLE "StudyMember" (
    ...
    "role" "StudyRole" NOT NULL DEFAULT 'MEMBER',
...
-- CreateIndex
CREATE UNIQUE INDEX "StudyMember_userId_studyGroupId_key" ON "StudyMember"("userId", "studyGroupId");
...
-- AddForeignKey
ALTER TABLE "StudyMember" ADD CONSTRAINT "StudyMember_studyGroupId_fkey" FOREIGN KEY ("studyGroupId") REFERENCES "StudyGroup"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
